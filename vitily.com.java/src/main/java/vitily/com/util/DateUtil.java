...
public class DateUtil {
    ...
    public static String FORMATESTR1 = "yyyy-MM-dd HH:mm:ss";
    ...
    public static SimpleDateFormat simpleDateFormat_Time = new SimpleDateFormat(FORMATESTR1);
    ...
    public static void main(String[] args){
        System.out.println(DateUtil.getCurDateTime("dd"));
    }
