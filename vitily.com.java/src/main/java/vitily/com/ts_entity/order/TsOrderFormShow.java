...
public class TsOrderFormShow extends BaseSearch<TbOrderFormShow> {
	public TsOrderFormShow(){
		super(new TbOrderFormShow());
	}
	/**
	 * 
	 */
	...
	private BigDecimal experiPrice;

	private Integer fromShowOwnerId;//商家id

	private List<Integer> dealStatus;
	...
	public BigDecimal getExperiPrice() {
		return experiPrice;
	}
	public void setExperiPrice(BigDecimal experiPrice) {
		this.experiPrice = experiPrice;
	}
	...
	public Integer getFromShowOwnerId() {
		return fromShowOwnerId;
	}

	public void setFromShowOwnerId(Integer fromShowOwnerId) {
		this.fromShowOwnerId = fromShowOwnerId;
	}

	public List<Integer> getDealStatus() {
		return dealStatus;
	}

	public void setDealStatus(List<Integer> dealStatus) {
